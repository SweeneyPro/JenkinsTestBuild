pipeline {
  ...
  stages {
    ...
    stage('Run Boot Stage 1') {
      steps {
        bat 'start C:\\Jenkins\\workspace\\JenkinsTestBuild_master-HSFE4JB3YDTDRHV5TTSFLB7QDJY25TPJ74C6A5YHH6YY2QGFGWPQ\\JenkinsTestBuild\\x64\\Debug\\JenkinsTestBuild.exe'
      }
    }
    stage('TestResults') {
      steps {
