  ...
  stages {
    ...
    stage('Run') {
      steps {
        ...
        sh 'C:\\Jenkins\\workspace\\JenkinsTestBuild_master-HSFE4JB3YDTDRHV5TTSFLB7QDJY25TPJ74C6A5YHH6YY2QGFGWPQ\\JenkinsTestBuild\\JenkinsTestBuild\\JenkinsTestBuild.exe'
      }
    }
  }
}